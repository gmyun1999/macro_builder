...
class KoLawList(models.Model):
    id = models.CharField(max_length=255, primary_key=True)
    현행연혁코드 = models.CharField(max_length=50, help_text="현행연혁코드")
    법령일련번호 = models.CharField(max_length=50, help_text="법령일련번호")
    자법타법여부 = models.CharField(max_length=50, blank=True, null=True, help_text="자법타법여부")
    법령상세링크 = models.CharField(max_length=500, help_text="법령상세링크")
    법령명한글 = models.CharField(max_length=255, help_text="법령명한글")
    법령구분명 = models.CharField(max_length=100, help_text="법령구분명")
    소관부처명 = models.CharField(max_length=255, help_text="소관부처명")
    공포번호 = models.CharField(max_length=50, help_text="공포번호")
    제개정구분명 = models.CharField(max_length=255, help_text="제개정구분명")
    소관부처코드 = models.CharField(max_length=50, help_text="소관부처코드")
    법령ID = models.CharField(max_length=50, help_text="법령ID")
    공동부령정보 = models.TextField(blank=True, null=True, help_text="공동부령정보")
    시행일자 = models.CharField(max_length=50, help_text="시행일자")
    공포일자 = models.CharField(max_length=50, help_text="공포일자")
